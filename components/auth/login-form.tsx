      ...
      <div className="bg-white rounded-lg shadow-md p-8">
        ...
        <div className="mt-6">
          ...
          <button
            ...
            disabled={loading}
            className="mt-3 w-full flex items-center justify-center gap-3 bg-gray-900 text-white py-2 px-4 rounded-md hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors font-medium"
          >
